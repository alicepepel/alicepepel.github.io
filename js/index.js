...
var tabs = document.querySelectorAll('.tab__input');
...
var priceSnapValues = [document.getElementById('price-snap-value-lower'), document.getElementById('price-snap-value-upper')];
...
var thcSnapValues = [document.getElementById('thc-snap-value-lower'), document.getElementById('thc-snap-value-upper')];
...
var cbdSnapValues = [document.getElementById('cbd-snap-value-lower'), document.getElementById('cbd-snap-value-upper')];
...
var checkTitle = document.querySelectorAll('.filter__title');
var _loop2 = function _loop2(_i) {
  checkTitle[_i].addEventListener('click', function (event) {
    checkTitle[_i].parentElement.classList.toggle('active');
  });
};
for (var _i = 0; _i < checkTitle.length; _i++) {
  _loop2(_i);
}
...
var badgeItem = document.querySelectorAll('.badge__item');
var _loop3 = function _loop3(_i2) {
  checkbox[_i2].addEventListener('click', function (event) {
    var data = checkbox[_i2].getAttribute('data-num');
    var checkText = checkbox[_i2].parentElement.querySelector('.checkbox__text');
    var str = checkText.innerHTML;
    var result = function filterItems() {
      return Object.values(badgeItem).filter(function (el) {
        return el.getAttribute('data-num') === data;
      });
    };
    if (result().length === 0) {
...
function deleteBadge() {
  var _loop4 = function _loop4(_i3) {
    badgeItem[_i3].addEventListener('click', function (event) {
      var checkbox = document.querySelectorAll('.checkbox__input');
      var data = badgeItem[_i3].getAttribute('data-num');
      var result = function filterItems() {
        return Object.values(checkbox).filter(function (el) {
          return el.getAttribute('data-num') === data;
        });
      };
      result()[0].checked = false;
      badgeItem[_i3].remove();
      badgeItem = document.querySelectorAll('.badge__item');
    });
  };
  for (var _i3 = 0; _i3 < badgeItem.length; _i3++) {
    _loop4(_i3);
  }
}
deleteBadge();